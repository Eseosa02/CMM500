				...
				@if (Auth::check() || Auth::guard('admin')->check())
					@if (Auth::check())
						@if (Auth::user()->isEmployer())
							<button id="toggle-user-sidebar"><img src="{{ Auth::user()->employerInfo->image ? asset(Auth::user()->employerInfo->image) : asset('assets/images/admin.png') }}" alt="avatar" class="thumb"></button>
						@else
							<button id="toggle-user-sidebar"><img src="{{ Auth::user()->candidateInfo->image ? asset(Auth::user()->candidateInfo->image) : asset('assets/images/admin.png') }}" alt="avatar" class="thumb"></button>
						@endif
					@endif
					@if (Auth::guard('admin')->check())
						<button id="toggle-user-sidebar"><img src="{{ asset('assets/images/admin.png') }}" alt="avatar" class="thumb"></button>
					@endif
				@else
					<!-- Login/Register -->
					<div class="login-box">
